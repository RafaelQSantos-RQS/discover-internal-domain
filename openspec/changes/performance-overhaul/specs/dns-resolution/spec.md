...
Execução concorrente de consultas DNS sobre as combinações geradas, com motor raw UDP estilo massdns, pool de resolvers, worker pool adaptativo, timeout por consulta e cancelamento, reportando subdomínios que resolvem.
